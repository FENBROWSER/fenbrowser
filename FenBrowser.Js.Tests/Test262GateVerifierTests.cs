...
public sealed class Test262GateVerifierTests
{
    ...
    [Fact]
    public void Verify_NonNumericCrashSummaryFromMissingFailuresSection_DoesNotEmitNewCrashViolationAgainstPreviousZero()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var previousPath = Path.Combine(tempRoot, "previous.json");
    ...
    [Fact]
    public void Verify_ZeroCrashSummaryFromMissingFailuresSection_DoesNotEmitNewCrashViolationAgainstPreviousZero()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var previousPath = Path.Combine(tempRoot, "previous.json");
    ...
    [Fact]
    public void Verify_NegativeCrashSummaryFromMissingFailuresSection_DoesNotEmitNewCrashViolationAgainstPreviousZero()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var previousPath = Path.Combine(tempRoot, "previous.json");
    ...
    [Fact]
    public void Verify_NullCrashSummaryFromMissingFailuresSection_DoesNotEmitNewCrashViolationAgainstPreviousZero()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var previousPath = Path.Combine(tempRoot, "previous.json");
    ...
    [Fact]
    public void Verify_ZeroUnknownCrashesFromNonArrayFailuresWithNonNumericSummary_DoesNotEmitUnknownCrashViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_NonNumericCrashSummaryFromNonArrayFailures_DoesNotEmitNoCrashesViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_NonNumericCrashSummaryFromNonArrayFailures_DoesNotEmitNewCrashViolationAgainstPreviousZero()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var previousPath = Path.Combine(tempRoot, "previous.json");
    ...
    [Fact]
    public void Verify_ReportIncludesZeroUnknownCrashesWhenFailuresSectionIsNotArrayAndSummaryCrashesIsNull()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_ZeroUnknownCrashesFromNonArrayFailuresWithNullSummary_DoesNotEmitUnknownCrashViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_NullCrashSummaryFromNonArrayFailures_DoesNotEmitNoCrashesViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_NullCrashSummaryFromNonArrayFailures_DoesNotEmitNewCrashViolationAgainstPreviousZero()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var previousPath = Path.Combine(tempRoot, "previous.json");
    ...
    [Fact]
    public void Verify_ZeroUnknownCrashesFromNonArrayFailuresWithZeroSummary_DoesNotEmitUnknownCrashViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_ZeroCrashSummaryFromNonArrayFailures_DoesNotEmitNoCrashesViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_ZeroCrashSummaryFromNonArrayFailures_DoesNotEmitNewCrashViolationAgainstPreviousZero()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var previousPath = Path.Combine(tempRoot, "previous.json");
    ...
    [Fact]
    public void Verify_NegativeUnknownCrashesFromNonArrayFailuresWithNegativeSummary_DoesNotEmitUnknownCrashViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_NegativeCrashSummaryFromNonArrayFailures_DoesNotEmitNoCrashesViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_NegativeCrashSummaryFromNonArrayFailures_DoesNotEmitNewCrashViolationAgainstPreviousZero()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var previousPath = Path.Combine(tempRoot, "previous.json");
    ...
    [Fact]
    public void Verify_ZeroUnknownCrashesFromNonArrayFailuresWithMissingSummary_DoesNotEmitUnknownCrashViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_MissingCrashSummaryFromNonArrayFailures_DoesNotEmitNoCrashesViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_MissingSummaryNonArrayFailuresWithEqualPasses_DoesNotEmitPassRegressionViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var previousPath = Path.Combine(tempRoot, "previous.json");
    ...
    [Fact]
    public void Verify_ReportIncludesZeroUnknownCrashesWhenFailuresIsStringAndSummaryCrashesIsNull()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_MissingCrashSummaryFromStringFailures_DoesNotEmitNoCrashesViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_MissingSummaryStringFailuresWithEqualPasses_DoesNotEmitPassRegressionViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var previousPath = Path.Combine(tempRoot, "previous.json");
    ...
    [Fact]
    public void Verify_MissingCrashSummaryFromStringFailures_DoesNotEmitNewCrashViolationAgainstPreviousZero()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var previousPath = Path.Combine(tempRoot, "previous.json");
    ...
    [Fact]
    public void Verify_ZeroUnknownCrashesFromStringFailuresWithNullSummary_DoesNotEmitUnknownCrashViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_NullCrashSummaryFromStringFailures_DoesNotEmitNoCrashesViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_NullCrashSummaryFromStringFailures_DoesNotEmitNewCrashViolationAgainstPreviousZero()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var previousPath = Path.Combine(tempRoot, "previous.json");
    ...
    [Fact]
    public void Verify_ReportIncludesZeroUnknownCrashesWhenFailuresIsStringAndSummaryCrashesIsNonNumeric()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_ZeroUnknownCrashesFromStringFailuresWithNonNumericSummary_DoesNotEmitUnknownCrashViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_ReportIncludesZeroUnknownCrashesWhenFailuresIsStringAndSummaryCrashesZero()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_ZeroUnknownCrashesFromStringFailures_DoesNotEmitUnknownCrashViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_ZeroCrashSummaryFromStringFailures_DoesNotEmitNoCrashesViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_ZeroCrashSummaryFromStringFailures_DoesNotEmitNewCrashViolationAgainstPreviousZero()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var previousPath = Path.Combine(tempRoot, "previous.json");
    ...
    [Fact]
    public void Verify_ReportIncludesNegativeUnknownCrashesWhenFailuresIsStringAndSummaryCrashesNegative()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_NegativeUnknownCrashesFromStringFailures_DoesNotEmitUnknownCrashViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_NegativeCrashSummaryFromStringFailures_DoesNotEmitNoCrashesViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_NegativeCrashSummaryFromStringFailures_DoesNotEmitNewCrashViolationAgainstPreviousZero()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var previousPath = Path.Combine(tempRoot, "previous.json");
    ...
    [Fact]
    public void Verify_NonNumericCrashSummaryFromStringFailures_DoesNotEmitNoCrashesViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_NonNumericCrashSummaryFromStringFailures_DoesNotEmitNewCrashViolationAgainstPreviousZero()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var previousPath = Path.Combine(tempRoot, "previous.json");
    ...
    [Fact]
    public void Verify_ZeroUnknownCrashesFromNumberFailuresWithMissingSummary_DoesNotEmitUnknownCrashViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_ReportIncludesZeroUnknownCrashesWhenFailuresIsNumberAndSummaryCrashesIsNull()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_MissingCrashSummaryFromNumberFailures_DoesNotEmitNoCrashesViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_ZeroUnknownCrashesFromNumberFailuresWithNullSummary_DoesNotEmitUnknownCrashViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_NullCrashSummaryFromNumberFailures_DoesNotEmitNoCrashesViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_NullCrashSummaryFromNumberFailures_DoesNotEmitNewCrashViolationAgainstPreviousZero()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var previousPath = Path.Combine(tempRoot, "previous.json");
    ...
    [Fact]
    public void Verify_ReportIncludesZeroUnknownCrashesWhenFailuresIsNumberAndSummaryCrashesIsNonNumeric()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_ZeroUnknownCrashesFromNumberFailuresWithNonNumericSummary_DoesNotEmitUnknownCrashViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_NonNumericCrashSummaryFromNumberFailures_DoesNotEmitNoCrashesViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_NonNumericCrashSummaryFromNumberFailures_DoesNotEmitNewCrashViolationAgainstPreviousZero()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var previousPath = Path.Combine(tempRoot, "previous.json");
    ...
    [Fact]
    public void Verify_ReportIncludesZeroUnknownCrashesWhenFailuresIsNumberAndSummaryCrashesZero()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_ZeroUnknownCrashesFromNumberFailures_DoesNotEmitUnknownCrashViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_ZeroCrashSummaryFromNumberFailures_DoesNotEmitNoCrashesViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_ZeroCrashSummaryFromNumberFailures_DoesNotEmitNewCrashViolationAgainstPreviousZero()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var previousPath = Path.Combine(tempRoot, "previous.json");
    ...
    [Fact]
    public void Verify_ReportIncludesNegativeUnknownCrashesWhenFailuresIsNumberAndSummaryCrashesNegative()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_NegativeUnknownCrashesFromNumberFailures_DoesNotEmitUnknownCrashViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_NegativeCrashSummaryFromNumberFailures_DoesNotEmitNoCrashesViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_NegativeCrashSummaryFromNumberFailures_DoesNotEmitNewCrashViolationAgainstPreviousZero()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var previousPath = Path.Combine(tempRoot, "previous.json");
    ...
    [Fact]
    public void Verify_ZeroUnknownCrashesFromBooleanFailuresWithMissingSummary_DoesNotEmitUnknownCrashViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_ReportIncludesZeroUnknownCrashesWhenFailuresIsBooleanAndSummaryCrashesIsNull()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_MissingCrashSummaryFromBooleanFailures_DoesNotEmitNoCrashesViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_MissingCrashSummaryFromBooleanFailures_DoesNotEmitNewCrashViolationAgainstPreviousZero()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var previousPath = Path.Combine(tempRoot, "previous.json");
    ...
    [Fact]
    public void Verify_ZeroUnknownCrashesFromBooleanFailuresWithNullSummary_DoesNotEmitUnknownCrashViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_NullCrashSummaryFromBooleanFailures_DoesNotEmitNoCrashesViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_NullCrashSummaryFromBooleanFailures_DoesNotEmitNewCrashViolationAgainstPreviousZero()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var previousPath = Path.Combine(tempRoot, "previous.json");
    ...
    [Fact]
    public void Verify_ReportIncludesZeroUnknownCrashesWhenFailuresIsBooleanAndSummaryCrashesIsNonNumeric()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_ZeroUnknownCrashesFromBooleanFailuresWithNonNumericSummary_DoesNotEmitUnknownCrashViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_NonNumericCrashSummaryFromBooleanFailures_DoesNotEmitNoCrashesViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_NonNumericCrashSummaryFromBooleanFailures_DoesNotEmitNewCrashViolationAgainstPreviousZero()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var previousPath = Path.Combine(tempRoot, "previous.json");
    ...
    [Fact]
    public void Verify_ReportIncludesZeroUnknownCrashesWhenFailuresIsBooleanAndSummaryCrashesZero()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_ZeroUnknownCrashesFromBooleanFailures_DoesNotEmitUnknownCrashViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_ZeroCrashSummaryFromBooleanFailures_DoesNotEmitNoCrashesViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_ZeroCrashSummaryFromBooleanFailures_DoesNotEmitNewCrashViolationAgainstPreviousZero()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var previousPath = Path.Combine(tempRoot, "previous.json");
    ...
    [Fact]
    public void Verify_ReportIncludesNegativeUnknownCrashesWhenFailuresIsBooleanAndSummaryCrashesNegative()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_NegativeUnknownCrashesFromBooleanFailures_DoesNotEmitUnknownCrashViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_NegativeCrashSummaryFromBooleanFailures_DoesNotEmitNoCrashesViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_NegativeCrashSummaryFromBooleanFailures_DoesNotEmitNewCrashViolationAgainstPreviousZero()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var previousPath = Path.Combine(tempRoot, "previous.json");
    ...
    [Fact]
    public void Verify_ZeroUnknownCrashesFromNullFailuresWithMissingSummary_DoesNotEmitUnknownCrashViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_ReportIncludesZeroUnknownCrashesWhenFailuresIsNullAndSummaryCrashesIsNull()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_MissingCrashSummaryFromNullFailures_DoesNotEmitNoCrashesViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_MissingCrashSummaryFromNullFailures_DoesNotEmitNewCrashViolationAgainstPreviousZero()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var previousPath = Path.Combine(tempRoot, "previous.json");
    ...
    [Fact]
    public void Verify_ZeroUnknownCrashesFromNullFailuresWithNullSummary_DoesNotEmitUnknownCrashViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_NullCrashSummaryFromNullFailures_DoesNotEmitNoCrashesViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_NullCrashSummaryFromNullFailures_DoesNotEmitNewCrashViolationAgainstPreviousZero()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var previousPath = Path.Combine(tempRoot, "previous.json");
    ...
    [Fact]
    public void Verify_ReportIncludesZeroUnknownCrashesWhenFailuresIsNullAndSummaryCrashesIsNonNumeric()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_ZeroUnknownCrashesFromNullFailuresWithNonNumericSummary_DoesNotEmitUnknownCrashViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_NonNumericCrashSummaryFromNullFailures_DoesNotEmitNoCrashesViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_NonNumericCrashSummaryFromNullFailures_DoesNotEmitNewCrashViolationAgainstPreviousZero()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var previousPath = Path.Combine(tempRoot, "previous.json");
    ...
    [Fact]
    public void Verify_ReportIncludesZeroUnknownCrashesWhenFailuresIsNullAndSummaryCrashesZero()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_ZeroUnknownCrashesFromNullFailures_DoesNotEmitUnknownCrashViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_ZeroCrashSummaryFromNullFailures_DoesNotEmitNoCrashesViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_ZeroCrashSummaryFromNullFailures_DoesNotEmitNewCrashViolationAgainstPreviousZero()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var previousPath = Path.Combine(tempRoot, "previous.json");
    ...
    [Fact]
    public void Verify_ReportIncludesNegativeUnknownCrashesWhenFailuresIsNullAndSummaryCrashesNegative()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_NegativeUnknownCrashesFromNullFailures_DoesNotEmitUnknownCrashViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_NegativeCrashSummaryFromNullFailures_DoesNotEmitNoCrashesViolation()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var currentPath = Path.Combine(tempRoot, "current.json");
    ...
    [Fact]
    public void Verify_NegativeCrashSummaryFromNullFailures_DoesNotEmitNewCrashViolationAgainstPreviousZero()
    {
        var tempRoot = Path.Combine(Path.GetTempPath(), "fenjs-test262-gate-" + Guid.NewGuid().ToString("N"));
        Directory.CreateDirectory(tempRoot);
        var previousPath = Path.Combine(tempRoot, "previous.json");
