...
| --- | --- |
| `MissingApiTrackerTests` | yes; 12 tests |
...
| Google passive classification | `logs/real-site/www.google.com/20260716T113726Z/` | Main UI visible; 25/25 missing-property records classify as 9 standard, 11 site expandos, 2 wrong receivers, 1 legacy probe, and 2 unclassified; 0 callback failures; 0 exceptions; blocker `none`; 26/26 artifacts | TESTED |
