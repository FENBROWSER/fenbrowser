...
| --- | --- | --- | --- |
| Google | `logs/real-site/www.google.com/20260715T084802Z/` | Main page rendered; current lifecycle/event loop agree on complete/DCL/load; the earlier loading sample is explicitly transition-time/timed-out; 18 completed script executions; 1 attributed unhandled Promise rejection; `first_blocker.json` is `none`; input not automated | TESTED |
