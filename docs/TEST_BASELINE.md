...
| Google passive classification | `logs/real-site/www.google.com/20260716T115831Z/` | Main UI visible; all 25 missing-property records classify as 11 standard, 11 site expandos, 2 wrong receivers, and 1 legacy probe; 0 unclassified; 0 callback failures; 0 exceptions; blocker `none`; 26/26 artifacts | TESTED |
