...
| 1 | Missing API classification lacks explicit prototype/stringifier metadata for 2 fresh Google plain-read observations | E / F | STUBBED | `20260716T114852Z` classifies 9 standard, 11 site expandos, 2 wrong-receiver, 1 legacy, and only `Location.toString`/`Navigator.geolocation` as unclassified; descriptor/property-check operations are now distinct |
