...
| 1 | Missing API classification lacks prototype/descriptor operation evidence, and Google candidates have not been freshly reclassified | E / F | STUBBED | The local bounded rich bundle retains unknown, expando, legacy, and checked-in-IDL standard cases with source/script/navigation/receiver provenance |
