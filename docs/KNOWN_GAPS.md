...
| 1 | Missing API classification lacks live assignment/prototype/checked-in-IDL evidence and the bundle still drops rich sidecar provenance | E / F | STUBBED | Local legacy and unknown reads classify correctly; Google candidates have not been freshly reclassified |
