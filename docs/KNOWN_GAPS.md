...
| 1 | Missing API classification lacks prototype/descriptor operation evidence for 13 fresh Google observations | E / F | STUBBED | `20260716T110854Z` classifies 9 standard, 2 wrong-receiver, 1 legacy, and 13 unclassified records with concrete receivers and full provenance |
