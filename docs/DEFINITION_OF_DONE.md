...
| 0-7 | **Cleanup audit guard passes** | `scripts/ci/run-code-cleanup-audit.ps1 -FailOnMedium` passes |
...
- [ ] `powershell -ExecutionPolicy Bypass -File scripts/ci/run-code-cleanup-audit.ps1 -FailOnMedium` passes
