...
| Missing API observation | TESTED | Schema-v2 tracker resolves concrete HTML receiver types plus embedded checked-in IDL inheritance/receiver evidence, records first arbitrary writes as page expandos, keeps unknown reads out of standards priority, and exports bounded rich records after logger drain; fresh Google retains 25 classified records | Prototype/descriptor evidence remains for 13 unclassified Google observations |
...
| Missing API bundle schema | TESTED | The bundle retains up to 512 ordered schema-v2 records with expando writes and full receiver/source/script/navigation provenance, plus explicit truncation counts; `20260716T110854Z` retains 25/25 records and concrete specialized HTML receivers | Prototype/descriptor operation evidence remains |
