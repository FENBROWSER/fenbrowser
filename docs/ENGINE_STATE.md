...
| Missing API bundle schema | TESTED | The bundle retains up to 512 ordered schema-v2 records with first/observed operation kinds, assignment timing, bounded boolean function-prototype marker evidence, and full receiver/source/script/navigation provenance; `20260716T113726Z` retains 25/25 records | Descriptor/stringifier operation evidence remains |
