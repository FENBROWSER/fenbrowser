...
| Missing API bundle schema | TESTED | The bundle retains up to 512 ordered schema-v2 records with first/observed operation kinds, assignment timing, and full receiver/source/script/navigation provenance; `20260716T112412Z` retains 25/25 records | Prototype/descriptor operation evidence remains |
