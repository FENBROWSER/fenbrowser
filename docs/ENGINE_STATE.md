...
| Missing API bundle schema | TESTED | The bundle retains up to 512 ordered schema-v2 records with first/observed read/write/descriptor/property-check kinds, descriptor target identity, assignment timing, bounded boolean function-prototype marker evidence, and full receiver/source/script/navigation provenance; `20260716T114852Z` retains 25/25 records | Explicit prototype/stringifier evidence remains |
