    ...
    public static class UsedValueComparator
    {
        ...
        private static string GetPropertyValue(CssComputed style, string property)
        {
            ...
            return property.ToLowerInvariant() switch
            {
                ...
                "margin-top" => style.Margin.Top.ToString(),
                "margin-right" => style.Margin.Right.ToString(),
                "margin-bottom" => style.Margin.Bottom.ToString(),
                "margin-left" => style.Margin.Left.ToString(),
                "padding-top" => style.Padding.Top.ToString(),
                "padding-right" => style.Padding.Right.ToString(),
                "padding-bottom" => style.Padding.Bottom.ToString(),
                "padding-left" => style.Padding.Left.ToString(),
