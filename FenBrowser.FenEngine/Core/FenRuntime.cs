    ...
    public class FenRuntime
    {
        ...
        private void InitializeBuiltins()
        {
            ...
            objectCtor.Set("defineProperties", FenValue.FromFunction(new FenFunction("defineProperties",
                ...
                {
                    if (args.Length < 2)
                        return FenValue.FromError("TypeError: Object.defineProperties requires 2 arguments");
                    var obj = args[0].AsObject();
                    if (obj == null)
                        return FenValue.FromError("TypeError: Object.defineProperties called on non-object");
            ...
            {
                if (args.Length == 0)
                    return FenValue.FromError("TypeError: Object.create requires at least 1 argument");
            ...
            objectCtor.Set("getOwnPropertyDescriptor", FenValue.FromFunction(new FenFunction("getOwnPropertyDescriptor",
                ...
                {
                    if (args.Length < 2)
                        return FenValue.FromError("TypeError: Object.getOwnPropertyDescriptor requires 2 arguments");
                    var obj = args[0].AsObject();
            ...
            arrayProto.Set("reduce", FenValue.FromFunction(new FenFunction("reduce", (args, thisVal) =>
            {
                ...
                if (len == 0 && args.Length < 2)
                    return FenValue.FromError("TypeError: Reduce of empty array with no initial value");
            ...
            // splice — ES3
            arrayProto.Set("splice", FenValue.FromFunction(new FenFunction("splice", (args, thisVal) =>
            {
                var arr = thisVal.AsObject();
                if (arr == null)
                {
            ...
            // reduceRight — ES5
            arrayProto.Set("reduceRight", FenValue.FromFunction(new FenFunction("reduceRight", (args, thisVal) =>
            {
                var arr = thisVal.AsObject();
                if (arr == null) return FenValue.Undefined;
                var callback = args.Length > 0 ? args[0].AsFunction() : null;
            ...
            // copyWithin — ES6
            arrayProto.Set("copyWithin", FenValue.FromFunction(new FenFunction("copyWithin", (args, thisVal) =>
            {
                var arr = thisVal.AsObject();
                if (arr == null) return thisVal;
                var len = (int)arr.Get("length").ToNumber();
            ...
            // keys — ES6 iterator
            arrayProto.Set("keys", FenValue.FromFunction(new FenFunction("keys", (args, thisVal) =>
            {
            ...
            // values — ES6 iterator
            arrayProto.Set("values", FenValue.FromFunction(new FenFunction("values", (args, thisVal) =>
            {
                var src = thisVal.AsObject() as FenObject;
                if (src == null) return FenValue.Undefined;
                int idx = 0;
            ...
            arrayProto.Set("entries", FenValue.FromFunction(new FenFunction("entries", (args, thisVal) =>
            {
                var src = thisVal.AsObject() as FenObject;
                if (src == null) return FenValue.Undefined;
                int idx = 0;
            ...
            // at — ES2022
            arrayProto.Set("at", FenValue.FromFunction(new FenFunction("at", (args, thisVal) =>
            {
                var arr = thisVal.AsObject();
                if (arr == null) return FenValue.Undefined;
                var len = (int)arr.Get("length").ToNumber();
            ...
            // flat — ES2019
            arrayProto.Set("flat", FenValue.FromFunction(new FenFunction("flat", (args, thisVal) =>
            {
            ...
            // flatMap — ES2019
            arrayProto.Set("flatMap", FenValue.FromFunction(new FenFunction("flatMap", (args, thisVal) =>
            {
                var arr = thisVal.AsObject();
                if (arr == null) return FenValue.FromObject(FenObject.CreateArray());
                var callback = args.Length > 0 ? args[0].AsFunction() : null;
                if (callback == null) return FenValue.FromError("TypeError: flatMap callback is not a function");
                var len = (int)arr.Get("length").ToNumber();
                var result = FenObject.CreateArray();
                int resultIdx = 0;
                for (int i = 0; i < len; i++)
            ...
            // findLast — ES2023
            arrayProto.Set("findLast", FenValue.FromFunction(new FenFunction("findLast", (args, thisVal) =>
            {
                var arr = thisVal.AsObject();
                if (arr == null) return FenValue.Undefined;
                var callback = args.Length > 0 ? args[0].AsFunction() : null;
            ...
            arrayProto.Set("findLastIndex", FenValue.FromFunction(new FenFunction("findLastIndex", (args, thisVal) =>
            {
                var arr = thisVal.AsObject();
                if (arr == null) return FenValue.FromNumber(-1);
                var callback = args.Length > 0 ? args[0].AsFunction() : null;
            ...
            arrayProto.Set("toReversed", FenValue.FromFunction(new FenFunction("toReversed", (args, thisVal) =>
            {
                var arr = thisVal.AsObject();
                if (arr == null) return FenValue.FromObject(FenObject.CreateArray());
                var len = (int)arr.Get("length").ToNumber();
            ...
            arrayProto.Set("toSorted", FenValue.FromFunction(new FenFunction("toSorted", (args, thisVal) =>
            {
                var arr = thisVal.AsObject();
                if (arr == null) return FenValue.FromObject(FenObject.CreateArray());
                var compareFn = args.Length > 0 && args[0].IsFunction ? args[0].AsFunction() : null;
                var len = (int)arr.Get("length").ToNumber();
                var items = new System.Collections.Generic.List<FenValue>();
                for (int i = 0; i < len; i++) items.Add(arr.Get(i.ToString()));
                items.Sort((a, b) =>
                {
                    if (compareFn != null) return (int)compareFn.Invoke(new[] { a, b }, _context).ToNumber();
                    return string.Compare(a.AsString(_context), b.AsString(_context), StringComparison.Ordinal);
                });
                var result = FenObject.CreateArray();
                for (int i = 0; i < items.Count; i++) result.Set(i.ToString(), items[i]);
                result.Set("length", FenValue.FromNumber(len));
                return FenValue.FromObject(result);
            })));

            // toSpliced — ES2023 (non-mutating)
            arrayProto.Set("toSpliced", FenValue.FromFunction(new FenFunction("toSpliced", (args, thisVal) =>
            {
                var arr = thisVal.AsObject();
                if (arr == null)
                {
            ...
            arrayProto.Set("with", FenValue.FromFunction(new FenFunction("with", (args, thisVal) =>
            {
                var arr = thisVal.AsObject();
                if (arr == null) return FenValue.FromObject(FenObject.CreateArray());
                var len = (int)arr.Get("length").ToNumber();
                int idx = args.Length > 0 ? (int)args[0].ToNumber() : 0;
                if (idx < 0) idx = len + idx;
                if (idx < 0 || idx >= len) return FenValue.FromError("RangeError: Invalid index");
            ...
            // at — ES2022
            stringProto.Set("at", FenValue.FromFunction(new FenFunction("at", (args, thisVal) =>
            {
                var str = thisVal.AsString(_context);
                int idx = args.Length > 0 ? (int)args[0].ToNumber() : 0;
            ...
            {
                if (!thisVal.IsSymbol) return FenValue.FromError("TypeError: Symbol.prototype.toString requires that 'this' be a Symbol");
            ...
            {
                if (!thisVal.IsSymbol) return FenValue.FromError("TypeError: Symbol.prototype.valueOf requires that 'this' be a Symbol");
                return thisVal; 
            })));
            ...
            dateProto.Set("getUTCMilliseconds", FenValue.FromFunction(new FenFunction("getUTCMilliseconds",
                (args, thisVal) =>
                {
                    try
                    {
            ...
            dateProto.Set("toISOString", FenValue.FromFunction(new FenFunction("toISOString", (args, thisVal) =>
            {
                ...
                {
                    return FenValue.FromError("RangeError: Invalid time value");
                }
            })));
            ...
            var aggCtor = new FenFunction("AggregateError", (args, thisVal) =>
            {
                ...
                var err = MakeError("AggregateError", message,
                    args.Length > 1 ? new[] { args[1] } : Array.Empty<FenValue>(), aggProto);
            ...
            iteratorProto.Set("[Symbol.iterator]",
                FenValue.FromFunction(new FenFunction("[Symbol.iterator]", (_, t) => t)));

            // map — lazy transform
            iteratorProto.Set("map", FenValue.FromFunction(new FenFunction("map", (a, t) =>
            {
            ...
            iteratorProto.Set("filter", FenValue.FromFunction(new FenFunction("filter", (a, t) =>
            {
                var fn = a.Length > 0 ? a[0].AsFunction() : null;
                if (fn == null) return FenValue.Undefined;
                var captured = t;
            ...
            iteratorProto.Set("take", FenValue.FromFunction(new FenFunction("take", (a, t) =>
            {
            ...
            iteratorProto.Set("drop", FenValue.FromFunction(new FenFunction("drop", (a, t) =>
            {
                int n = a.Length > 0 ? (int)a[0].ToNumber() : 0;
                var captured = t;
            ...
            iteratorProto.Set("flatMap", FenValue.FromFunction(new FenFunction("flatMap", (a, t) =>
            {
                var fn = a.Length > 0 ? a[0].AsFunction() : null;
                if (fn == null) return FenValue.Undefined;
                var captured = t;
            ...
            iteratorProto.Set("toArray", FenValue.FromFunction(new FenFunction("toArray", (a, t) =>
            {
                var arr = FenObject.CreateArray();
                int i = 0;
            ...
            iteratorProto.Set("forEach", FenValue.FromFunction(new FenFunction("forEach", (a, t) =>
            {
                var fn = a.Length > 0 ? a[0].AsFunction() : null;
                if (fn == null) return FenValue.Undefined;
                int i = 0;
            ...
            iteratorProto.Set("reduce", FenValue.FromFunction(new FenFunction("reduce", (a, t) =>
            {
                var fn = a.Length > 0 ? a[0].AsFunction() : null;
                if (fn == null) return FenValue.Undefined;
            ...
            iteratorProto.Set("some", FenValue.FromFunction(new FenFunction("some", (a, t) =>
            {
                var fn = a.Length > 0 ? a[0].AsFunction() : null;
            ...
            iteratorProto.Set("every", FenValue.FromFunction(new FenFunction("every", (a, t) =>
            {
                var fn = a.Length > 0 ? a[0].AsFunction() : null;
            ...
            iteratorProto.Set("find", FenValue.FromFunction(new FenFunction("find", (a, t) =>
            {
                var fn = a.Length > 0 ? a[0].AsFunction() : null;
                if (fn == null) return FenValue.Undefined;
                foreach (var v in DrainIteratorObj(t))
            ...
            iteratorProto.Set("findIndex", FenValue.FromFunction(new FenFunction("findIndex", (a, t) =>
            {
                var fn = a.Length > 0 ? a[0].AsFunction() : null;
            ...
            iteratorProto.Set("constructor", FenValue.FromFunction(iteratorCtor));
            ...
            iteratorCtor.Set("from", FenValue.FromFunction(new FenFunction("from", (args, thisVal) =>
            {
                ...
                if (iterable.IsObject)
                {
                    ...
                    if (symIterVal.IsFunction)
                    {
                        ...
                        if (symIterObj != null)
                        {
                            IEnumerable<FenValue> FromSymIter()
                            {
                                var nxtFn2 = symIterObj.Get("next");
                                if (!nxtFn2.IsFunction) yield break;
                                var fn2 = nxtFn2.AsFunction();
                                while (true)
                                {
                                    var r2 = fn2.Invoke(Array.Empty<FenValue>(), null);
                                    var ro2 = r2.AsObject() as FenObject;
                                    if (ro2 == null || ro2.Get("done").ToBoolean()) yield break;
                                    yield return ro2.Get("value");
                                }
                            }
                            return FenValue.FromObject(MakeIteratorObject(FromSymIter()));
                        }
                    }
            ...
            objectConstructor.Set("defineProperty", FenValue.FromFunction(new FenFunction("defineProperty",
                (args, thisVal) =>
                {
                    ...
                    if (hasGet || hasSet)
                    {
                        var hasDataFields = !descObj.Get("value", null).IsUndefined ||
                                            !descObj.Get("writable", null).IsUndefined;
                        if (hasDataFields)
                        {
                        ...
                        // ES5.1 8.10.5 step 7.b: If getter is not undefined and is not callable, throw TypeError
                        if (!getVal.IsUndefined && !getVal.IsFunction)
                            return FenValue.FromError("TypeError: Getter must be a function or undefined");
                        // ES5.1 8.10.5 step 8.b: If setter is not undefined and is not callable, throw TypeError
                        if (!setVal.IsUndefined && !setVal.IsFunction)
                            return FenValue.FromError("TypeError: Setter must be a function or undefined");
            ...
            objectConstructor.Set("defineProperties", FenValue.FromFunction(new FenFunction("defineProperties",
                (args, thisVal) =>
                {
                    ...
                    if (propsObj == null)
                        return FenValue.FromError(
                            "TypeError: Object.defineProperties: second argument must be an object");
            ...
            objectConstructor.Set("getOwnPropertyDescriptor", FenValue.FromFunction(new FenFunction(
                "getOwnPropertyDescriptor", (args, thisVal) =>
                {
                    ...
                    var obj = args[0].AsObject() as FenObject;
                    if (obj == null) return FenValue.Undefined; // primitive with no own properties
                    var prop = args[1].ToString();
                    var desc = obj?.GetOwnPropertyDescriptor(prop);
            ...
            objectProto.Set("propertyIsEnumerable", FenValue.FromFunction(new FenFunction("propertyIsEnumerable",
                (args, thisVal) =>
                {
                    var prop = args.Length > 0 ? args[0].ToString() : "";
                    var obj = thisVal.AsObject() as FenObject;
            ...
            objectProto.Set("toLocaleString", FenValue.FromFunction(new FenFunction("toLocaleString", (args, thisVal) =>
                objectProto.Get("toString", null).AsFunction()?.Invoke(args, null) ??
                FenValue.FromString("[object Object]"))));
                ...
                try
                {
                    if (Uri.TryCreate(requestedUrl, UriKind.Absolute, out var resolved))
                    {
                        ...
                        location.Set("pathname",
                            FenValue.FromString(string.IsNullOrEmpty(resolved.AbsolutePath)
                                ? "/"
            ...
            // Array.fromAsync(asyncIterable, mapFn?) - ES2024
            // Returns a Promise<Array> that resolves from an async or sync iterable.
            arrayConstructor.Set("fromAsync", FenValue.FromFunction(new FenFunction("fromAsync", (args, thisVal) =>
            {
                ...
                var mapFnAsync = args.Length > 1 && args[1].IsFunction ? args[1].AsFunction() : null;

                // Build array synchronously (async-iterable awaiting requires full event-loop integration;
                // for the synchronous subset this covers the most common patterns).
                var resultArr = FenObject.CreateArray();
                int idxAsync = 0;

                if (asyncIterable.IsObject)
                {
                    var iterableObj = asyncIterable.AsObject() as FenObject;
                    if (iterableObj != null)
                    {
                        // Try Symbol.asyncIterator first, then Symbol.iterator, then array-like
                        var asyncIterMethod = iterableObj.Get("[Symbol.asyncIterator]");
                        var syncIterMethod = iterableObj.Get("[Symbol.iterator]");

                        FenValue iteratorVal = FenValue.Undefined;
                        var iterCtx = new ExecutionContext { ThisBinding = asyncIterable };
                        if (asyncIterMethod.IsFunction)
                            iteratorVal = asyncIterMethod.AsFunction().Invoke(Array.Empty<FenValue>(), iterCtx);
                        else if (syncIterMethod.IsFunction)
                            iteratorVal = syncIterMethod.AsFunction().Invoke(Array.Empty<FenValue>(), iterCtx);
                        ...
                        if (iteratorObj != null)
                        {
                            ...
                            if (nextFnVal.IsFunction)
                            {
                                ...
                                {
                                    var nextResult = nextFn.Invoke(Array.Empty<FenValue>(), null);
                                    // Unwrap Promise if needed (synchronous resolution only)
                                    var nextResultObj = nextResult.AsObject() as FenObject;
                                    if (nextResultObj is JsPromise nextPromise && nextPromise.IsFulfilled)
                                    {
                                        nextResultObj = nextPromise.Result.AsObject() as FenObject;
                                        if (nextResultObj == null) break;
                                    }
                                    if (nextResultObj == null || nextResultObj.Get("done").ToBoolean()) break;
                                    var elem = nextResultObj.Get("value");
                                    // Unwrap Promise value if already resolved
                                    if (elem.IsObject && elem.AsObject() is JsPromise elemP && elemP.IsFulfilled)
                                        elem = elemP.Result;
                                    var mappedElem = mapFnAsync != null
                                        ? mapFnAsync.Invoke(new FenValue[] { elem, FenValue.FromNumber(idxAsync) }, null)
                                        : elem;
                                    resultArr.Set(idxAsync.ToString(), mappedElem, null);
                                    idxAsync++;
                                }
                            }
                        }
                        ...
                        {
                            // Array-like fallback
                            var lenVal2 = iterableObj.Get("length");
                            int len2 = lenVal2.IsNumber ? (int)lenVal2.ToNumber() : 0;
                            for (int i = 0; i < len2; i++)
                            {
                                var elem = iterableObj.Get(i.ToString());
                                var mappedElem = mapFnAsync != null
                                    ? mapFnAsync.Invoke(new FenValue[] { elem, FenValue.FromNumber(i) }, null)
                                    : elem;
                                resultArr.Set(idxAsync.ToString(), mappedElem, null);
                                idxAsync++;
                            }
                ...
                resultArr.Set("length", FenValue.FromNumber(idxAsync), null);
                // Wrap in a resolved Promise
                return FenValue.FromObject(JsPromise.Resolve(FenValue.FromObject(resultArr), _context));
            })));
            ...
            SetGlobal("CustomEvent", FenValue.FromFunction(new FenFunction("CustomEvent",
                (FenValue[] args, FenValue thisVal) =>
                {
                    var type = args.Length > 0 ? args[0].ToString() : "";
                    bool bubbles = false;
                    ...
                    return FenValue.FromObject(
                        new FenBrowser.FenEngine.DOM.CustomEvent(type, bubbles, cancelable, detail));
                })));
            ...
            performanceObj.Set("getEntries",
                FenValue.FromFunction(new FenFunction("getEntries",
                    (args, thisVal) => { return FenValue.FromObject(FenObject.CreateArray()); })));
            ...
            performanceObj.Set("mark",
                FenValue.FromFunction(new FenFunction("mark", (args, thisVal) => FenValue.Undefined)));
            performanceObj.Set("measure",
                FenValue.FromFunction(new FenFunction("measure", (args, thisVal) => FenValue.Undefined)));
            performanceObj.Set("clearMarks",
                FenValue.FromFunction(new FenFunction("clearMarks", (args, thisVal) => FenValue.Undefined)));
            performanceObj.Set("clearMeasures",
                FenValue.FromFunction(new FenFunction("clearMeasures", (args, thisVal) => FenValue.Undefined)));
            ...
            SetGlobal("structuredClone", FenValue.FromFunction(new FenFunction("structuredClone", (args, thisVal) =>
            {
                ...
                FenValue DeepClone(FenValue v, int depth)
                {
                    if (depth > 50) return v; // cycle guard
                    ...
                    foreach (var key in src.Keys())
                        clone.Set(key, DeepClone(src.Get(key), depth + 1));
                    return FenValue.FromObject(clone);
                }

                return DeepClone(args[0], 0);
            })));
                        ...
                        if (computedStyle != null)
                        {
                            ...
                            csObj.Set("getPropertyValue", FenValue.FromFunction(new FenFunction("getPropertyValue",
                                (gpArgs, gpThis) =>
                                {
                                    ...
                                    var val = computedStyle.Map?.ContainsKey(prop) == true
                                        ? computedStyle.Map[prop]
                                        : "";
                                    return FenValue.FromString(val ?? "");
                                })));
                            // Common properties
            ...
            SetGlobal("Proxy", FenValue.FromFunction(new FenFunction("Proxy", (FenValue[] args, FenValue thisVal) =>
            {
                ...
                proxy.Set("get", FenValue.FromFunction(new FenFunction("get", (getArgs, getThis) =>
                {
                    ...
                    if (getTrap != null)
                    {
                        return getTrap.Invoke(
                            new FenValue[]
                                { FenValue.FromObject(target), FenValue.FromString(prop), FenValue.FromObject(proxy) },
                            _context);
                    }
                ...
                proxy.Set("set", FenValue.FromFunction(new FenFunction("set", (setArgs, setThis) =>
                {
                    ...
                    if (setTrap != null)
                    {
                        return setTrap.Invoke(
                            new FenValue[]
                            {
                                FenValue.FromObject(target), FenValue.FromString(prop), val, FenValue.FromObject(proxy)
                            }, _context);
                    }
                ...
                proxy.Set("has", FenValue.FromFunction(new FenFunction("has", (hasArgs, hasThis) =>
                {
                    ...
                    if (hasTrap != null)
                    {
                        return hasTrap.Invoke(new FenValue[] { FenValue.FromObject(target), FenValue.FromString(prop) },
                            _context);
                    }
                ...
                proxy.Set("deleteProperty", FenValue.FromFunction(new FenFunction("deleteProperty",
                    (delArgs, delThis) =>
                    {
                        ...
                        if (delTrap != null)
                        {
                            return delTrap.Invoke(
                                new FenValue[] { FenValue.FromObject(target), FenValue.FromString(prop) }, _context);
                        }
            ...
            {
                if (args.Length == 0 || !args[0].IsFunction)
                    return FenValue.FromError("Promise resolver undefined is not a function");
            ...
            stringProto.Set("trimStart",
                FenValue.FromFunction(new FenFunction("trimStart",
                    (FenValue[] args, FenValue thisVal) => FenValue.FromString(thisVal.ToString().TrimStart()))));
            stringProto.Set("trimEnd",
                FenValue.FromFunction(new FenFunction("trimEnd",
                    (FenValue[] args, FenValue thisVal) => FenValue.FromString(thisVal.ToString().TrimEnd()))));
            stringProto.Set("trim",
                FenValue.FromFunction(new FenFunction("trim",
                    (FenValue[] args, FenValue thisVal) => FenValue.FromString(thisVal.ToString().Trim()))));
            ...
            SetGlobal("WeakMap",
                FenValue.FromFunction(new FenFunction("WeakMap",
                    (args, thisVal) => FenValue.FromObject(new JsWeakMap()))));
            SetGlobal("WeakSet",
                FenValue.FromFunction(new FenFunction("WeakSet",
                    (args, thisVal) => FenValue.FromObject(new JsWeakSet()))));
            ...
            SetGlobal("Uint8Array", FenValue.FromFunction(new FenFunction("Uint8Array", (args, thisVal) =>
                FenValue.FromObject(new JsUint8Array(args.Length > 0 ? args[0] : null, args.Length > 1 ? args[1] : null,
                    args.Length > 2 ? args[2] : null)))));

            SetGlobal("Float32Array", FenValue.FromFunction(new FenFunction("Float32Array", (args, thisVal) =>
                FenValue.FromObject(new JsFloat32Array(args.Length > 0 ? args[0] : null,
            ...
            {
                if (args.Length == 0 || !args[0].IsObject)
                    return FenValue.FromError("TypeError: WeakRef: Target must be an object");
                var target = args[0].AsObject();
            ...
            SetGlobal("FinalizationRegistry", FenValue.FromFunction(new FenFunction("FinalizationRegistry",
                ...
                {
                    if (args.Length == 0 || !args[0].IsFunction)
                        return FenValue.FromError("TypeError: Constructor requires a cleanup callback");
                    var callback = args[0].AsFunction();
                    ...
                    registry.Set("unregister",
                        FenValue.FromFunction(new FenFunction("unregister",
                            (uArgs, uThis) => { return FenValue.FromBoolean(true); })));
            ...
            temporalNow.Set("instant", FenValue.FromFunction(new FenFunction("instant", (args, thisVal) =>
            {
                ...
                instant.Set("epochNanoseconds",
                    FenValue.FromNumber(DateTimeOffset.UtcNow.ToUnixTimeMilliseconds() * 1_000_000));
            ...
            temporalNow.Set("zonedDateTimeISO", FenValue.FromFunction(new FenFunction("zonedDateTimeISO",
                (args, thisVal) =>
                {
            ...
            generatorFunctionProto.Set(FenBrowser.FenEngine.Core.Types.JsSymbol.ToStringTag.ToPropertyKey(),
            ...
            var functionCtor = new FenFunction("Function", (args, thisVal) =>
            {
                ...
                if (_context != null && !_context.Permissions.Check(FenBrowser.FenEngine.Security.JsPermissions.Eval))
                {
                    ...
                    return FenValue.FromError("EvalError: Refused to create a function from string because 'unsafe-eval' is not allowed by the current security policy.");
                }
            ...
            functionPrototype.Set("call", FenValue.FromFunction(new FenFunction("call", (args, thisVal) =>
            {
                ...
                // Pass newThis as the ThisBinding so fn sees correct 'this'
                var callCtx = new ExecutionContext { ThisBinding = newThis };
                return fn.Invoke(fnArgs, callCtx);
            })), null);
            ...
            functionPrototype.Set("apply", FenValue.FromFunction(new FenFunction("apply", (args, thisVal) =>
            {
                ...
                // Pass newThis as the ThisBinding so fn sees correct 'this'
                var applyCtx = new ExecutionContext { ThisBinding = newThis };
                return fn.Invoke(fnArgs, applyCtx);
            })), null);
            ...
            functionPrototype.Set("bind", FenValue.FromFunction(new FenFunction("bind", (args, thisVal) =>
            {
                ...
                return FenValue.FromFunction(new FenFunction("bound", (newArgs, _) =>
                {
                    ...
                    // Pass boundThis as ThisBinding so the callee sees the correct 'this'
                    var bindCtx = new ExecutionContext { ThisBinding = boundThis };
                    return fn.Invoke(allArgs, bindCtx);
                }));
            })), null);
            ...
            stringConstructor.Set("matchAll", FenValue.FromFunction(new FenFunction("matchAll", (args, thisVal) =>
            {
                ...
                if (regexpVal.IsObject)
                {
                    ...
                    if (globalFlag.HasValue && globalFlag.Value.IsBoolean && !globalFlag.Value.ToBoolean())
                        return FenValue.FromError("TypeError: String.prototype.matchAll called with a non-global RegExp argument");
                }
                ...
                if (_windowEventListeners.ContainsKey(type))
                {
                    ...
                    foreach (var listener in listeners)
                    {
                        if (listener.IsFunction)
                        {
                            ...
                            try
                            {
                                listener.AsFunction().Invoke(new[] { evt }, _context);
                            }
                            catch
                            {
                            }
        ...
        private FenFunction CreateTypedArrayConstructor(string name, int bytesPerElement)
        {
            return new FenFunction(name, (args, thisVal) =>
            {
                ...
                arr.Set("set",
                    FenValue.FromFunction(new FenFunction("set",
                        (setArgs, setThis) => { return FenValue.Undefined; })));

                // subarray(begin, end) - Creates a new view
                arr.Set("subarray",
                    FenValue.FromFunction(new FenFunction("subarray", (subArgs, subThis) => { return thisVal; })));
