    ...
    public static class PerformanceDiagnosticsStore
    {
        ...
        public static void RecordNavigation(RenderTelemetrySnapshot? telemetry)
        {
            ...
            lock (Sync)
            {
                ...
                Navigations.Add(new NavigationPerformanceSnapshot(
                    ...
                    frame?.LayoutAllocatedBytes ?? 0,
                    frame?.PaintAllocatedBytes ?? 0,
                    frame?.RasterAllocatedBytes ?? 0,
            ...
            RenderFrameTelemetry telemetry)
        {
            return navigation with
            {
                ...
                LayoutAllocatedBytes = telemetry.LayoutAllocatedBytes,
                PaintAllocatedBytes = telemetry.PaintAllocatedBytes,
                RasterAllocatedBytes = telemetry.RasterAllocatedBytes,
