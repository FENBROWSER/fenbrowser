    ...
    public static class SelectorMatcher
    {
        ...
        private static bool MatchesPseudoClass(Element el, string name, string args, List<SelectorChain> parsedArgs, int depth)
        {
            ...
            switch (name.ToLowerInvariant())
            {
                ...
                case "last": return IsLastChild(el);
                case "only": return IsOnlyChild(el);
                ...
                case "seeking": return ElementStateManager.IsSeekingMedia(el);
                case "buffering": return ElementStateManager.IsBufferingMedia(el);
                ...
                case "active-view-transition-type": return ElementStateManager.IsActiveViewTransitionType(el, args);
                case "state": return ElementStateManager.IsCustomState(el, args);
                ...
                case "focus-visible": return ElementStateManager.Instance.IsFocusVisible(el);
