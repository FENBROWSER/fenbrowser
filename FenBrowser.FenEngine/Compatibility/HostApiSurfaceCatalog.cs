...
"Legacy JavaScriptEngine crypto bridge now provides digest(), generateKey(), importKey(), exportKey(), encrypt(), decrypt(), sign(), and verify() for HMAC, AES-GCM, and RSASSA-PKCS1-v1_5 (65537 exponent), with fail-closed usage/extractability/parameter checks and deterministic thenable settlement; derive/wrap families remain pending."),
