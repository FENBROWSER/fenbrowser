...
/// <summary>
/// macOS window wrapper implementing the cross-platform IWindow interface.
/// </summary>
...
/// <summary>
/// macOS implementation of IPlatformHost using Silk.NET.
/// </summary>
internal sealed class MacOSPlatformHost : IPlatformHost
{
    ...
    public IClipboard Clipboard { get; } = new MacOSClipboard();
    ...
    {
        // macOS handles DPI automatically
    }
